...
{   
	...
	//cub albastru 
	GLfloat diffuseCoeffb [ ] = {0.0, 0.0, 1.0, 0.0};
	//glMaterialfv (GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, diffuseCoeffb);
	...
	GLfloat diffuseCoeffv2[] = { 1.0, 0.0, 1.0, 0.0 };
	//glMaterialfv (GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, diffuseCoeffv);
	glMaterialfv(GL_FRONT_AND_BACK, GL_EMISSION, diffuseCoeffv2);
	...
	GLfloat diffuseCoeffr2[] = { 1.0, 0.0, 0.0, 1.0 };
	//glMaterialfv (GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, diffuseCoeffr);
	glMaterialfv(GL_FRONT_AND_BACK, GL_EMISSION, diffuseCoeffr2);
	...
	GLfloat specularCoeffalb2[] = { 0.0, 1.0, 0.0, 1.0 };
	...
	glMaterialfv(GL_FRONT_AND_BACK, GL_EMISSION, specularCoeffalb2);
